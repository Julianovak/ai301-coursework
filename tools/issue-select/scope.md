...
I'm comfortable with python, SQL, and Java, and have some experience with 
data work (pandas, SQL) and machine learning basics. I want to get better 
at applied data/AI work — things like data pipelines, model evaluation, 
or ML tooling — and building real-world experience reading and 
contributing to production codebases in that space. I'd like to avoid 
issues that are purely front-end/UI work or deep in areas unrelated to 
data/AI, like low-level systems programming or infrastructure/DevOps config.
